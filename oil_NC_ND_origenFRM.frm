...
Begin VB.Form oil_NC_ND_origenFRM 
   BackColor       =   &H80000018&
   ...
   Begin FPSpreadADO.fpSpread spd 
      ...
      SpreadDesigner  =   "oil_NC_ND_origenFRM.frx":0000
   End
End
Attribute VB_Name = "oil_NC_ND_origenFRM"
...
Private Sub Form_Load()
  ...
  strSQL = "select * from oil_ND_NC_origen_vw where empresaID = " & _
...
Private Sub spd_DblClick(ByVal Col As Long, ByVal Row As Long)
  ...
  Dim varComprobante As Variant
  
    'tomo valores
    Me.spd.GetText 1, Row, varComprobante
    
    'los guardo para poder calcular
    Frm.txtOrigen = varComprobante
