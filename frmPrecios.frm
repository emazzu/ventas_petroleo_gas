   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPrecios.frx":08DA
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPrecios.frx":11B4
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPrecios.frx":1A8E
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPrecios.frx":3420
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPrecios.frx":3CFA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPrecios.frx":45D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPrecios.frx":5F66
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
  ...
  strRangoIso = adoLastPeriod("ViewPrecios", "fecha")
  
  strSQL = "SELECT * FROM ViewPrecios where fecha between " & strRangoIso.strDesde & " and " & strRangoIso.strHasta & " " & _
           "ORDER BY fecha DESC"

  intRes = ListViewAppearanceChange(lvwDatos)
  intRes = ListViewRefresh(lvwDatos, strSQL, strStruc)
  intRes = lvwHideColumn(lvwDatos, "orden")
...
Private Sub tlbOperaciones_ButtonClick(ByVal Button As MSComctlLib.Button)
  ...
  Case Is = "agregar"
      ...
      ' muestro formulario
      frmPreciosInfo.Show vbModal
      
      ' descargo formulario
      Unload frmPreciosInfo
  ...
  Case Is = "modificar"
    ...
    If lvwDatos.SelectedItem > 0 Then
      ...
      ' cargo formulario
      Load frmPreciosUpdate
    
      ' paso los valores del list view al formulario
      With frmPreciosUpdate
      ' le paso los datos
      .txtDato1 = lvwGetValue(lvwDatos, "valorMinimo")
      .txtDato2 = lvwGetValue(lvwDatos, "valormaximo")
      ' pinto campo para edicion
      frmPreciosUpdate.txtDato1.SelLength = Len(frmPreciosUpdate.txtDato1)
      frmPreciosUpdate.txtDato2.SelLength = Len(frmPreciosUpdate.txtDato2)
      .Show vbModal
      End With
      ...
      If blnAceptar Then
        ...
        With frmPreciosUpdate
        strSQL = "EXEC spPreciosUpdate " & _
        lvwGetValue(lvwDatos, "orden") & "," & _
        Val(.txtDato1) & "," & _
        Val(.txtDato2)
        End With
    ...
    Case Is = "eliminar"
      ...
      If lvwDatos.SelectedItem > 0 Then
        ...
        If intRes = vbYes Then
          ...
          strSQL = "EXEC spPreciosDelete " & Me.lvwDatos.SelectedItem
          a = adoExecSQL(strSQL)
          blnRefresh = True
  ...
  If blnRefresh Then
    ...
    strSQL = "SELECT * FROM ViewPrecios" & _
